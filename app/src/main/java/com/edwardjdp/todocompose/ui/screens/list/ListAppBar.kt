...
import com.edwardjdp.todocompose.ui.components.DisplayAlertDialog
import com.edwardjdp.todocompose.ui.components.PriorityItem
...
import com.edwardjdp.todocompose.util.TrailingIconState
    ...
    when(searchAppBarState) {
        SearchAppBarState.CLOSED -> {
            DefaultListAppBar(
                ...
                onSortClicked = sharedViewModel::persistSortState,
            ...
            SearchAppBar(
                ...
                onTextChanged = { query ->
                    sharedViewModel.searchTextState.value = query
                },
                onCloseClicked = {
                    sharedViewModel.searchAppBarState.value = SearchAppBarState.CLOSED
                    sharedViewModel.searchTextState.value = String.Empty
                },
                onSearchClicked = sharedViewModel::searchDatabase
            )
        }
    }
}
...
fun DeleteAllAction(
    ...
    IconButton(
        ...
        Icon(
            painterResource(id = R.drawable.ic_vertical_more),
                    ...
                    onClick = {
                        when(trailingIconState) {
                            TrailingIconState.READY_TO_DELETE -> {
                                onTextChanged(String.Companion.Empty)
